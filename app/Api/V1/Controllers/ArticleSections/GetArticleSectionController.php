...
class GetArticleSectionController extends BaseController
{
    /**
     * @OA\Get(
     *      path="/articles/sections/{id}",
     *      operationId="getArticleSectionById",
     *      tags={"ArticleSection"},
     *      summary="Get specific article section",
     *      description="Returns article section data",
     *      security={{"passport":{}}},
     *     @OA\Parameter(
     *          name="id",
    ...
    public function __invoke(Request $request, $id)
    {
        try {
            ...
            return $this->response->item($user, new ArticleSectionTransformer());
